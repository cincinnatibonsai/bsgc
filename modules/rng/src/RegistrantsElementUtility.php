...
/**
 * Helper class for the element type "registrants".
 *
 * @see \Drupal\rng\Element\Registrants
 */
class RegistrantsElementUtility {
  ...
  /**
   * Constructs a new RegistrantsElementUtility object.
   *
   * @param array $element
   *   The form array of the registrants element.
  ...
  /**
   * Adds the given registrant to the list.
   *
  ...
  /**
   * Counts referenceable identities for an event.
   *
   ...
   */
  public function countReferenceableEntities(EntityInterface $event, string $entity_type_id, array $bundles = []) {
