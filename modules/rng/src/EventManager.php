...
class EventManager implements EventManagerInterface {
  ...
  public function getMeta(EntityInterface $entity) {
    ...
    if (!isset($this->eventMeta[$entity_type][$id])) {
      $this->eventMeta[$entity_type][$id] = EventMeta::createInstance($this->container, $entity);
    }

    return $this->eventMeta[$entity_type][$id];
  }
