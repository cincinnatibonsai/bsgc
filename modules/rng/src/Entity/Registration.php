...
class Registration extends ContentEntityBase implements RegistrationInterface {
  ...
  public function hasIdentity(EntityInterface $identity): bool {
    foreach ($this->identitiesUnsaved as $identity_unsaved) {
  ...
  public function addIdentity(EntityInterface $identity): RegistrationInterface {
    ...
    $this->identitiesUnsaved[] = $identity;
    return $this;
  }
  ...
  public function postSave(EntityStorageInterface $storage, $update = TRUE) {
    ...
    foreach ($this->identitiesUnsaved as $k => $identity) {
      $registrant = $registrant_factory->createRegistrant([
        'event' => $this->getEvent(),
      ]);
      $registrant
        ...
        ->save();
      unset($this->identitiesUnsaved[$k]);
    }
    $this->createStubs();
  }
