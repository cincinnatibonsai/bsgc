...
class EventTypeAccessDefaultsForm extends EntityForm {
  ...
  /**
   * Builds operation options for a single Event type rule.
   *
   * @param \Drupal\rng\Entity\EventTypeRuleInterface $rule
   *   The Event type rule for which to build operations.
   * @param array $operations
   *   The operations to build.
   * @param bool $scope_all
   *   If actions apply to all registrations.
   * @param bool $supports_create
   *   If the operation 'create' applies to the Event type rule.
   *
   * @return array
   *   The operation options, if there are any. An empty array otherwise.
   */
  public function actionRows(EventTypeRuleInterface $rule, array $operations, bool $scope_all, bool $supports_create): array {
