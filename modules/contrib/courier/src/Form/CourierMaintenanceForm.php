...
class CourierMaintenanceForm extends FormBase {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    $time = \Drupal::time()->getRequestTime() - $form_state->getValue('delete_age');
    ...
    $this->messenger()->addMessage($this->formatPlural(count($ids), '@count message deleted.', '@count messages deleted.'));
  }
